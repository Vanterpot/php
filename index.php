...
<?php
define('AUTHOR', 'Специалист');
define('YEAR', date('Y'));
define('DBHOST', 'localhost');
define('DBLOGIN', 'username');
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="delivery.html"><?php echo $menu[0] ?></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="contacts.html"><?php echo $menu[1] ?></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="login.html"><?php echo $menu[2] ?></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="basket.html"><?php echo $menu[3] ?></a>
          </li>
